...
{
	public class CreateMultipleEffectWarhead : Warhead
	{
		[SequenceReference(nameof(Image), allowNullImage: true)]
		[Desc("List of explosion sequences that can be used.")]
		public readonly Dictionary<int, string[]> Explosions = new Dictionary<int, string[]> { };
		...
		public override void DoImpact(in Target target, WarheadArgs args)
		{
			...
			var explosions = Explosions.RandomOrDefault(world.LocalRandom).Value;
			if (Image != null && explosions != null)
			{
