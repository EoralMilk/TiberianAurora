...
namespace OpenRA.Mods.TA.Traits
{
	...
	public class AttackChargesBurstsInfo : AttackOmniInfo
	{
		...
		public override object Create(ActorInitializer init) { return new AttackChargesBursts(init.Self, this); }
	}
	...
	public class AttackChargesBursts : AttackOmni, INotifyAttack, INotifySold
	{
		...
		public AttackChargesBursts(Actor self, AttackChargesBurstsInfo info)
			: base(self, info)
		{
			this.info = info;
		}
