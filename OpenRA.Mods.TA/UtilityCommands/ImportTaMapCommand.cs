...
namespace OpenRA.Mods.TA.UtilityCommands
{
	class ImportTaMapCommand : IUtilityCommand
	{
		string IUtilityCommand.Name { get { return "--import-ta-map"; } }
		bool IUtilityCommand.ValidateArguments(string[] args) { return args.Length >= 2; }

		private static readonly List<string> SkipActor = new List<string>()
		{
		};
		...
		[Desc("FILENAME", "Convert a RedAlert2 map to the OpenRA format.")]
